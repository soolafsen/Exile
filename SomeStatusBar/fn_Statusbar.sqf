...
[] spawn {
	...
	while {true} do 
	{
		...
		{
			diag_log "[RG] Statusbar is loading.";
			disableSerialization;
			_rscLayer = "StatusBarExile" call BIS_fnc_rscLayer;
			_rscLayer cutRsc["StatusBarExile","PLAIN"];			
		};
		...
		format["<t size='1' shadow='0' shadowColor='#707070' color='%10'> </t>
		<t size='1' shadow='0' shadowColor='#707070' color='%10'><img size='1' image='custom\statusIcons\icons\health.paa' color='%5'/> %4%1</t>		
		<t size='1' shadow='0' shadowColor='#707070' color='%10'><img size='1' image='custom\statusIcons\icons\hunger.paa' color='%11'/> %10%1</t> 
		<t size='1' shadow='0' shadowColor='#707070' color='%10'><img size='1' image='custom\statusIcons\icons\thirst.paa' color='%13'/> %12%1</t>		
		<t size='1' shadow='0' shadowColor='#707070' color='%10'><img size='1' image='custom\statusIcons\icons\poptabs.paa' color='%7'/> %6</t>
		<t size='1' shadow='0' shadowColor='#707070' color='%10'><img size='1' image='custom\statusIcons\icons\locker.paa' color='%9'/> %8</t> 			
		<t size='1' shadow='0' shadowColor='#707070' color='%10'><img size='1' image='custom\statusIcons\icons\respect.paa' color='%17'/> %16</t>			
		<t size='1' shadow='0' shadowColor='#707070' color='%10'><img size='1' image='custom\statusIcons\icons\compass.paa' color='%21'/> %19</t>
		<t size='1' shadow='0' shadowColor='#707070' color='%10'><img size='1' image='custom\statusIcons\icons\players.paa' color='%3'/> %2</t>
		<t size='1' shadow='0' shadowColor='#707070' color='%10'><img size='1' image='custom\statusIcons\icons\restart.paa' color='%24'/> Restart: %22:%23</t>
		<t size='1' shadow='0' shadowColor='#707070' color='%10'><img size='1' image='custom\statusIcons\icons\fps.paa' color='%15'/> %14</t>",
