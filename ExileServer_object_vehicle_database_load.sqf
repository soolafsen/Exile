...
private["_vehicleID","_isVGing","_data","_position","_vectorDirection","_vectorUp","_pinCode","_texture","_vehicleObject","_lock","_unlockInSafeZonesAfterRestart","_isLocked","_hitpoints","_cargoContainers"];
_vehicleID = _this select 0;
_isVGing = _this select 1;
...
if(((typeName (_data select 24)) isEqualTo "SCALAR") and _isVGing isEqualTo false) exitWith {};
